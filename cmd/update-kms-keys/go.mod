module github.com/numeroai/flow-wallet-api/cmd/update-kms-keys

go 1.23.4

require (
	github.com/onflow/flow-go-sdk v1.2.2
	github.com/onflow/flow-go-sdk/examples v0.0.0-20250410171116-0f47cc5d0049
...
require (
	github.com/flow-hydraulics/flow-wallet-api v0.11.0
